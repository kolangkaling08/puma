...
# === 0. Redirect root domain ke /jpterus66 (misalnya https://domainmu.com → https://domainmu.com/jpterus66)
RewriteRule ^$ jpterus66 [R=301,L]

# === 1. Biarkan file .txt, .xml, robots.txt langsung diakses tanpa rewrite
